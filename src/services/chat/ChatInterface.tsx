                ...
                <div
                  className={`rounded-2xl px-4 py-3 ${
                    message.sender === 'user'
                      ...
                      : 'bg-card border border-border text-foreground mr-2'
                  }`}
                >
          ...
          {isTyping && (
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <div className="bg-card border border-border rounded-2xl px-4 py-3 mr-2">
      ...
      <div className="p-4 bg-card border-t border-border">
        <div className="flex items-center space-x-2">
          <Button
            variant="ghost"
            size="sm"
            className="p-2 hover:bg-primary/10 rounded-xl flex-shrink-0"
          >
          ...
          <div className="flex-1 relative">
            <Input
              ...
              className="rounded-2xl border-border bg-background pr-12"
            />
            <Button
              variant="ghost"
              size="sm"
              className="absolute right-2 top-1/2 transform -translate-y-1/2 p-1 hover:bg-primary/10 rounded-xl"
            >
          ...
          <Button
            ...
            className={`p-3 rounded-2xl flex-shrink-0 ${
              newMessage.trim() 
                ? 'bg-primary hover:bg-primary-medium text-primary-foreground' 
